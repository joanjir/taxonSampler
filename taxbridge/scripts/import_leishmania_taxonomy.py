...
LEISHMANIA_JSON = r'C:/Users/joanj/Downloads/leishmania_taxonomy.json'

with open(LEISHMANIA_JSON, encoding='utf-8') as f:
    data = json.load(f)

def main():
    for entry in data:
        sci_name = entry['species']
        ...
        # Buscar genomes por input_name y species
